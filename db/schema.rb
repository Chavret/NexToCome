...
ActiveRecord::Schema.define(version: 20170328090018) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "first_name"
    t.string   "last_name"
    t.string   "newsletter",             default: "Subscribe"
    ...
    t.index ["calendar_token"], name: "index_users_on_calendar_token", using: :btree
